...
public class FunctionCombinationExercise {
    ...
    public void personHasNotEmptyLastNameAndFirstName2() {
        ...
        Predicate<Person> validateFirstName = negate1(hasEmptyFirstName);//null; // TODO use negate
        Predicate<Person> validateLastName = negate1(hasEmptyLastName);//null; // TODO use negate

        Predicate<Person> validate = validateFirstNameAndLastName(validateFirstName, validateLastName);//null; // TODO use and
    ...
    public void personHasNotEmptyLastNameAndFirstName3() {
        ...
        Predicate<Person> validateFirstName = hasEmptyFirstName.negate();//null; // TODO use Predicate->negate
        Predicate<Person> validateLastName = hasEmptyLastName.negate();//null; // TODO use Predicate->negate

        Predicate<Person> validate = validateFirstName.and(validateLastName); //null; // TODO use Predicate->and
